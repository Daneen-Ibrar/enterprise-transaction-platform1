...
public class InvoicePdfService {
    ...
    public byte[] generateInvoicePdf(Invoice invoice) {
        ...
        try {
            ...
            table.addCell(createCell("Amount: " + invoice.getCurrency() + " " + invoice.getAmount().toPlainString(), normalFont));
            ...
            // Footer
            Paragraph footer = new Paragraph("This invoice is generated by the Enterprise Transaction Platform.", new Font(Font.HELVETICA, 10, Font.ITALIC));
